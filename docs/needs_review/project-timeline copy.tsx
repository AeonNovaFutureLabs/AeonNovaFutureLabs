...
import { Calendar, GitBranch, Database, Brain, Activity, LucideIcon } from 'lucide-react';
...
const TimelineItem: React.FC<TimelineItemProps> = ({ phase, timeline, items, icon: Icon }) => (
  <div className="mb-8">
    <div className="flex items-center mb-2">
      ...
      <Badge className="ml-2">{timeline}</Badge>
    </div>
    <div className="pl-12">
